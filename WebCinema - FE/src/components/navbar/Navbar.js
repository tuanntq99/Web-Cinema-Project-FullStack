        ...
        <header>
          ...
          <div className={`links-box ${classAdd ? "" : "active"}`}>
            <ul className="links">
              <li>
                <Link to="/">
                  <RiHome2Line className="link-icon" />
                  Home
                </Link>
              </li>
              <li>
                <Link to="/movie">
                  <RiMovie2Line className="link-icon" />
                  Movies
                </Link>
              </li>
              <li>
                <Link to="/show">
                  <MdSlideshow className="link-icon" />
                  TV Shows
                </Link>
              </li>
              <li>
                <Link to="/actor">
                  <RiBearSmileLine className="link-icon" />
                  Actors
                </Link>
              </li>
              <li>
                <Link to="/settings">
                  <RiSettingsLine className="link-icon" />
                  Settings
                </Link>
              </li>
              <li>
